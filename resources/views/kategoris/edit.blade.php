...
@section('title', 'Edit Kategori - Inventaris SMKN 2 SBY')
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <nav class="flex items-center gap-1.5 text-sm text-zinc-500">
        ...
        <span class="font-medium text-zinc-900">Edit Kategori</span>
    </nav>
    ...
    <div>
        ...
        <h2 class="text-2xl font-bold tracking-tight text-zinc-900">Edit Kategori</h2>
        <p class="text-sm text-zinc-500">Perbarui nama kategori. Kode kategori tidak dapat diubah.</p>
    </div>
        ...
        <form action="{{ route('kategoris.update', $kategori->id) }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <p class="text-xs text-zinc-400">
                    Kode ini di-generate otomatis saat kategori pertama kali dibuat dan bersifat permanen.
                </p>
            </div>
