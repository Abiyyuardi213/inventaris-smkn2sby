...
@section('title', 'Daftar Kategori Barang - Inventaris SMKN 2 SBY')
...
<div class="space-y-6">
    ...
    <nav class="flex items-center gap-1.5 text-sm text-zinc-500">
        ...
        <span class="font-medium text-zinc-900">Kategori Barang</span>
    </nav>

    {{-- Header Section --}}
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h2 class="text-2xl font-bold tracking-tight text-zinc-900">Daftar Kategori Barang</h2>
            <p class="text-sm text-zinc-500">Kelola kategori kelompok barang inventaris aset SMKN 2 Surabaya.</p>
        </div>
        <div>
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-16 text-center text-zinc-500">
                                <div class="flex flex-col items-center justify-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-semibold text-zinc-700">Belum ada data Kategori Barang</p>
        ...
        @if ($kategoris->isNotEmpty())
            <div class="px-6 py-3 border-t border-zinc-100 bg-zinc-50/50">
                <p class="text-xs text-zinc-400">
                    Menampilkan <span class="font-medium text-zinc-600">{{ $kategoris->count() }}</span> Kategori Barang
                </p>
            </div>
        @endif
    </div>
...
<script>
    function confirmDelete(id, nama) {
        Swal.fire({
            ...
            html: `Anda akan menghapus data Kategori Barang <strong>"${nama}"</strong>.<br>
                   <span class="text-sm text-gray-500">Barang inventaris dengan Kategori ini tidak dapat dihapus jika masih terkait.</span>`,
            icon: 'warning',
