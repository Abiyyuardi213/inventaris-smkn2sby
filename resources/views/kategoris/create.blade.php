...
@section('title', 'Tambah Kategori - Inventaris SMKN 2 SBY')
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div>
        ...
        <h2 class="text-2xl font-bold tracking-tight text-zinc-900">Tambah Kategori Baru</h2>
        <p class="text-sm text-zinc-500">Isi nama kategori — kode akan di-generate otomatis oleh sistem.</p>
    </div>
        ...
        <form action="{{ route('kategoris.store') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <input
                    ...
                    placeholder="Contoh: Elektronik Audio Visual, Perabot Kantor"
            ...
            <div class="rounded-md bg-teal-50 border border-teal-200/60 px-4 py-3 flex items-start gap-3">
                ...
                <div>
                    <p class="text-xs font-semibold text-teal-700">Kode Kategori akan di-generate otomatis</p>
                    <p class="text-xs text-teal-600 mt-0.5">
                        Sistem akan membuat kode dari singkatan huruf kapital tiap kata + nomor urut.<br>
                        Contoh: <span class="font-mono font-semibold">"Elektronik Audio Visual"</span>
                        → <span class="font-mono font-semibold bg-teal-100 px-1 rounded">EAV-001</span>
                    </p>
                </div>
            </div>
