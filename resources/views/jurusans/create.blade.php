...
@section('title', 'Tambah Jurusan - Inventaris SMKN 2 SBY')
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <nav class="flex items-center gap-1.5 text-sm text-zinc-500">
        ...
        <span class="font-medium text-zinc-900">Tambah Jurusan</span>
    </nav>
    ...
    <div>
        ...
        <h2 class="text-2xl font-bold tracking-tight text-zinc-900">Tambah Jurusan Baru</h2>
        <p class="text-sm text-zinc-500">Isi nama jurusan — kode akan di-generate otomatis oleh sistem.</p>
    </div>
    ...
    <div class="rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
        <form action="{{ route('jurusans.store') }}" method="POST" class="space-y-6">
            ...
            <div class="rounded-md bg-indigo-50 border border-indigo-200/60 px-4 py-3 flex items-start gap-3">
                ...
                <div>
                    <p class="text-xs font-semibold text-indigo-700">Kode Jurusan akan di-generate otomatis</p>
                    <p class="text-xs text-indigo-600 mt-0.5">
                        Sistem akan membuat kode dari singkatan huruf kapital tiap kata + nomor urut.<br>
                        Contoh: <span class="font-mono font-semibold">"Teknik Komputer Jaringan"</span>
                        → <span class="font-mono font-semibold bg-indigo-100 px-1 rounded">TKJ-001</span>
                    </p>
                </div>
            </div>
