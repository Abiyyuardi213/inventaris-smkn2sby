...
@section('title', 'Edit Gedung & Bangunan (KIB C)')
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-2xl font-bold text-zinc-900 tracking-tight">Edit Gedung & Bangunan (KIB C)</h1>
            <p class="text-sm text-zinc-500 mt-0.5">Perbarui informasi detail data aset gedung atau bangunan.</p>
        </div>
    </div>

    {{-- Form Container --}}
    <form action="{{ route('gedung-dan-bangunan.update', $gedungDanBangunan->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-xl border border-zinc-200 p-6 shadow-sm space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="kode_inventaris" id="kode_inventaris" value="{{ old('kode_inventaris', $gedungDanBangunan->kode_inventaris) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="nama_barang" id="nama_barang" value="{{ old('nama_barang', $gedungDanBangunan->nama_barang) }}" required
                ...
                <div>
                    ...
                    <select name="jenis_modal_id" id="jenis_modal_id"
                        ...
                        @foreach($jenisModals as $jm)
                            <option value="{{ $jm->id }}" {{ (old('jenis_modal_id', $gedungDanBangunan->jenis_modal_id) == $jm->id) ? 'selected' : '' }}>
                                {{ $jm->nama_jenis_modal }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="kategori_id" id="kategori_id"
                        ...
                        @foreach($kategoris as $kat)
                            <option value="{{ $kat->id }}" {{ old('kategori_id', $gedungDanBangunan->kategori_id) == $kat->id ? 'selected' : '' }}>
                                {{ $kat->nama_kategori }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="jurusan_id" id="jurusan_id" onchange="filterRuangan()"
                        ...
                        @foreach($jurusans as $jur)
                            <option value="{{ $jur->id }}" {{ old('jurusan_id', $gedungDanBangunan->jurusan_id) == $jur->id ? 'selected' : '' }}>
                                {{ $jur->nama_jurusan }}
                            </option>
                        @endforeach
                    </select>
                    ...
                    <select name="ruangan_id" id="ruangan_id"
                        ...
                        @foreach($ruangans as $ruang)
                            <option value="{{ $ruang->id }}"
                                    ...
                                    {{ old('ruangan_id', $gedungDanBangunan->ruangan_id) == $ruang->id ? 'selected' : '' }}>
                                {{ $ruang->nama_ruangan }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <select name="kondisi" id="kondisi" required
                        class="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500">
                        <option value="baik" {{ old('kondisi', $gedungDanBangunan->kondisi) == 'baik' ? 'selected' : '' }}>B : Baik</option>
                        <option value="rusak_ringan" {{ old('kondisi', $gedungDanBangunan->kondisi) == 'rusak_ringan' ? 'selected' : '' }}>RR : Rusak Ringan</option>
                        <option value="rusak_sedang" {{ old('kondisi', $gedungDanBangunan->kondisi) == 'rusak_sedang' ? 'selected' : '' }}>RS : Rusak Sedang</option>
                        <option value="rusak_berat" {{ old('kondisi', $gedungDanBangunan->kondisi) == 'rusak_berat' ? 'selected' : '' }}>RB : Rusak Berat</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="konstruksi_bertingkat" id="konstruksi_bertingkat" required
                        class="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500">
                        <option value="Tidak" {{ old('konstruksi_bertingkat', $gedungDanBangunan->konstruksi_bertingkat) == 'Tidak' ? 'selected' : '' }}>Tidak (Bukan Bertingkat)</option>
                        <option value="Bertingkat" {{ old('konstruksi_bertingkat', $gedungDanBangunan->konstruksi_bertingkat) == 'Bertingkat' ? 'selected' : '' }}>Bertingkat (Tingkat)</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="konstruksi_beton" id="konstruksi_beton" required
                        class="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500">
                        <option value="Beton" {{ old('konstruksi_beton', $gedungDanBangunan->konstruksi_beton ?? 'Beton') == 'Beton' ? 'selected' : '' }}>Beton (BTN)</option>
                        <option value="Tidak" {{ old('konstruksi_beton', $gedungDanBangunan->konstruksi_beton) == 'Tidak' ? 'selected' : '' }}>Tidak (Bukan Beton)</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="luas_lantai" id="luas_lantai" value="{{ old('luas_lantai', $gedungDanBangunan->luas_lantai) }}"
                        class="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="luas_tanah" id="luas_tanah" value="{{ old('luas_tanah', $gedungDanBangunan->luas_tanah) }}"
                        class="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="status_tanah" id="status_tanah" value="{{ old('status_tanah', $gedungDanBangunan->status_tanah ?? 'Hak Pakai') }}"
                        class="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="nomor_kode_tanah" id="nomor_kode_tanah" value="{{ old('nomor_kode_tanah', $gedungDanBangunan->nomor_kode_tanah) }}"
                        class="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500 font-mono">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="dokumen_nomor" id="dokumen_nomor" value="{{ old('dokumen_nomor', $gedungDanBangunan->dokumen_nomor) }}"
                        class="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="dokumen_tanggal" id="dokumen_tanggal" value="{{ old('dokumen_tanggal', optional($gedungDanBangunan->dokumen_tanggal)->format('Y-m-d')) }}"
                        class="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500">
                </div>
                ...
                <div class="md:col-span-3">
                    ...
                    <textarea name="lokasi_alamat" id="lokasi_alamat" rows="2"
                        class="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500">{{ old('lokasi_alamat', $gedungDanBangunan->lokasi_alamat) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl border border-zinc-200 p-6 shadow-sm space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="harga_satuan" id="harga_satuan" value="{{ old('harga_satuan', $gedungDanBangunan->harga_satuan) }}" required
                        class="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500 font-mono">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="jumlah_total" id="jumlah_total" value="{{ old('jumlah_total', $gedungDanBangunan->jumlah_total) }}" min="1" required
                        class="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="sumber_dana" id="sumber_dana" value="{{ old('sumber_dana', $gedungDanBangunan->sumber_dana) }}"
                        class="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_catat_aset" id="tanggal_catat_aset" value="{{ old('tanggal_catat_aset', optional($gedungDanBangunan->tanggal_catat_aset)->format('Y-m-d')) }}" required
                        class="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl border border-zinc-200 p-6 shadow-sm space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    <input type="url" name="foto_url" id="foto_url" value="{{ old('foto_url', $gedungDanBangunan->foto_url) }}" placeholder="https://drive.google.com/file/d/... atau https://drive.google.com/drive/folders/..."
