...
<head>
    ...
    <title>KIB C - Gedung dan Bangunan</title>
...
<body>
    ...
    <div class="no-print-toolbar">
        ...
        <form method="GET" action="{{ route('inventaris.print-kib-c') }}" style="display: flex; align-items: center; gap: 8px;">
        ...
        <table class="kib-table">
            <thead>
                <tr>
                    ...
                    <th rowspan="2" style="width: 55px;">Luas (M2)</th>
                    <th rowspan="2" style="width: 65px;">Status Tanah</th>
                    <th rowspan="2" style="width: 75px;">Nomor Kode Tanah</th>
                ...
                <tr>
                    ...
                    <th style="width: 55px;">Beton (tidak)</th>
                ...
                @empty
                    <tr>
                        <td colspan="17" style="padding: 20px; text-align: center; color: #71717a;">
                            Belum ada data barang Gedung dan Bangunan (KIB C).
                        </td>
                    </tr>
                @endforelse
            </tbody>
