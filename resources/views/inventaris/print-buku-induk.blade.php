        ...
        <table class="buku-induk-table">
            <thead>
                <tr>
                    ...
                    <th rowspan="2" style="width: 110px;">Jenis Modal</th>
                    <th rowspan="2" style="width: 90px;">Kategori</th>
                    <th rowspan="2" style="width: 85px;">Tanggal Catat Aset</th>
                ...
                <tr>
                    ...
                    <th style="width: 45px;">Volume</th>
                    <th style="width: 50px;">Satuan</th>
                    <th style="width: 75px;">Harga Satuan</th>
                    <th style="width: 80px;">Jumlah</th>
                    <th style="width: 95px;">Nomor BAST</th>
                    <th style="width: 85px;">Tanggal BAST</th>
                </tr>
            ...
            <tbody>
                ...
                @forelse ($items as $index => $item)
                    ...
                    @php($totalVolume += $item->jumlah_total)
                    <tr>
                        <td>{{ $index + 1 }}</td>
                        ...
                        <td class="nowrap">{{ $item->tanggal_catat_aset ? $item->tanggal_catat_aset->translatedFormat('d F Y') : '-' }}</td>
                        ...
                        <td class="nowrap">{{ $item->tanggal_bast ? $item->tanggal_bast->translatedFormat('d F Y') : '-' }}</td>
            ...
            <tfoot>
                <tr style="font-weight: 700; background-color: #fafafa;">
                    <td colspan="10" style="text-align: center;">Jumlah Total</td>
