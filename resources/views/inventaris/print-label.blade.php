...
<body class="flex flex-col items-center justify-center min-h-screen p-4 antialiased font-sans">

    <!-- Control Panel (Hidden when printed) -->
    <div class="no-print mb-6 flex items-center gap-3 bg-white p-4 border border-zinc-200 rounded-xl shadow-sm">
