...
@section('title', 'Tambah Ruangan - Inventaris SMKN 2 SBY')
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <nav class="flex items-center gap-1.5 text-sm text-zinc-500">
        ...
        <span class="font-medium text-zinc-900">Tambah Ruangan</span>
    </nav>
    ...
    <div class="rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
        <form action="{{ route('ruangans.store') }}" method="POST" class="space-y-6">
            @csrf
