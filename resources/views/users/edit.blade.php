...
@section('title', 'Ubah Pengguna - Inventaris SMKN 2 SBY')
@section('page_title', 'Ubah Pengguna')
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div>
        ...
        <h2 class="text-2xl font-bold tracking-tight text-zinc-900">Ubah Pengguna</h2>
        <p class="text-sm text-zinc-500">Perbarui profil pengguna dan hak akses sistem.</p>
    </div>
        ...
        <form action="{{ route('users.update', $user->id) }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-4 pt-2 border-t border-zinc-100">
                <div>
                    ...
                    <p class="text-xs text-zinc-500">Kosongkan kolom di bawah ini jika Anda tidak ingin merubah kata sandi pengguna.</p>
                </div>
